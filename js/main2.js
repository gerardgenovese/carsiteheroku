...
document.body.addEventListener('click', function(e){
  ...
  if(e.target.classList.contains('explore-car') || e.target.classList.contains('explore-car__front') && e.target.classList.contains('camry')) {
    ...
    let camryAlt = document.getElementById('car-color');
...
function changeWhite() {
  ...
  // AVALON
    ...
    if (getEndPosition == null) {
      white.src = 'img/avalon/side-front/avalon-side-front-white.jpg';
...
////--SELECT VEHICLE DROP DOWN MENU---////////
 ...
 document.getElementById('car-build-toggle').addEventListener('click', () => {
     selectVehicleCount++;
 ...
 function openSelectVehiclesMenu() {
   document.getElementById('select-vehicle').style.height = '250px';
   // document.getElementById('main').style.marginLeft = '250px';
 };
...
//   sessionStorage.setItem('endPosition','img/corolla/side-front/corolla-side-front-blue.jpg')
